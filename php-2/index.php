...
<body>
    ...
    // 18 - I Love PHP
    // 20- I Love PHP
    echo "Output: LOOPING PERTAMA <br>";
    for ($i = 1; $i <= 20; $i++) {
        if ($i % 2 == 0) {
    ...
    //     4 - I Love PHP
    //     2 - I Love PHP
    // Lakukan Looping Di Sini echo "<h3>Soal No 2 Looping Array Modulo </h3>";
    echo "<h3>Soal No 2 Looping Array Modulo </h3>";
    echo "Output: LOOPING KEDUA <br>";
    for ($i = 20; $i > 1; $i--) {
        if ($i % 2 == 0) {
            echo $i . ' - I Love PHP <br>';
        }
    ...
    echo "Sisa bagi/modulus 5 dari angka didalam array <br>";
    ...
    foreach ($numbers as $key) {
        echo "<br> Sisa pembagian " . $key . " adalah " . $key % 5;
    }
    ...
    echo "<h3>Soal No 3 Array Asosiatif</h3>";
    $data = array();
